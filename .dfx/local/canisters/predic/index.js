...
import { idlFactory } from './predic.did.js';
export { idlFactory } from './predic.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_PREDIC;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./predic.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the predic canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./predic.did.js")._SERVICE>}
 */
export const predic = createActor(canisterId);
